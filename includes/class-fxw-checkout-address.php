 ...
 *
 * FoodXpress is a single-restaurant, coordinates-only delivery plugin:
...
class FXW_Checkout_Address
{
	...
	public function relabel_address_field($fields)
	{
		...
		$fields['address_1']['label'] = __('Flat / Floor / Block / Society / Tower', 'foodxpress');
		$fields['address_1']['placeholder'] = __('e.g. Flat 4B, 2nd floor, Tower A, Green Valley Society', 'foodxpress');
