/**
 * FoodXpress Agent — service worker for the delivery dashboard PWA.
 *
 * Served by `?fxw_agent_sw=1` with `Service-Worker-Allowed: /` so it can
...
const CACHE_VERSION = 'fxw-agent-v1';
const DASHBOARD_URL = self.registration.scope;
const PLUGIN_ASSETS = '/wp-content/plugins/foodxpress-for-woocommerce/assets/';
...
const OFFLINE_HTML =
	...
	'<title>Offline — FoodXpress Agent</title>' +
