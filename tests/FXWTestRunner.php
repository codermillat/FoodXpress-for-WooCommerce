...
class FXWTestRunner
{
    ...
    private function testFileStructure()
    {
        ...
        $required_files = [
            ...
            'includes/class-fxw-checkout-address.php' => 'Checkout address simplification (hide locale + relabel)',
            ...
            'includes/services/class-fxw-map-provider-client.php' => 'Map provider HTTP client',
            'includes/class-fxw-settings-extra.php' => 'Settings extension sibling',
            'includes/class-fxw-settings-maps.php' => 'Map provider settings',
