...
class FXW_Shortcodes {
	...
	public function print_receipt() {
		...
		// Security check: Ensure the current user is the assigned delivery boy.
		$delivery_boy_id = get_current_user_id();
		$assigned_delivery_boy = $order->get_meta( '_fxw_delivery_boy_id' );
		if ( $delivery_boy_id != $assigned_delivery_boy && ! current_user_can( 'manage_options' ) ) {
...
'wc-completed'      => __( 'Delivered', 'foodxpress' ),
		...
		?>
        <div class="fxw-order-status-wrapper">
        ...
        <div class="fxw-order-status-wrapper">
            <div class="fxw-order-status-header">
                ...
                <p class="fxw-current-status-text"><?php echo esc_html( wc_get_order_status_name( $current_status ) ); ?></p>
            </div>
            <div class="fxw-status-tracker">
                <div class="fxw-status-line"></div>
            ...
            <?php if ( $delivery_boy_id && $current_status_index >= 1 ) : ?>
                ...
                <div class="fxw-delivery-boy-info">
                    <h4><?php _e( 'Your Delivery Rider', 'foodxpress' ); ?></h4>
                    <p>
                        <span class="fxw-icon">&#128100;</span>
                        <strong><?php echo esc_html( $delivery_boy->display_name ); ?></strong>
                        <a href="tel:<?php echo esc_attr( get_user_meta( $delivery_boy_id, 'billing_phone', true ) ); ?>" class="fxw-button-call"><?php _e( 'Call', 'foodxpress' ); ?></a>
                    </p>
                </div>
            <?php endif; ?>
        </div>
