...
- **Current version:** **v1.2.14** (2026-08-17 — v1.2.2–1.2.14: Zomato/Swiggy-style checkout, coordinates-only fee engine + saved-address defaults, WC-compat hardening, dead-code cleanup, privacy integration, config health warning, region-neutral defaults; repo public, GPL-3.0-or-later. See CHANGELOG.md)
