<?php
/**
 * FoodXpress Order Status Email Template (HTML)
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/fxw-order-status.php
 *
 * @package FoodXpress/Templates/Emails
 * @version 1.1.0
 */
...
<div style="margin-bottom: 40px;">
    <table class="td" cellspacing="0" cellpadding="6"
        ...
        <thead>
            <tr>
                <th class="td" scope="col" style="text-align:left;"><?php esc_html_e('Product', 'foodxpress'); ?></th>
                <th class="td" scope="col" style="text-align:left;"><?php esc_html_e('Quantity', 'foodxpress'); ?></th>
                <th class="td" scope="col" style="text-align:left;"><?php esc_html_e('Price', 'foodxpress'); ?></th>
            </tr>
        </thead>
        <tbody>
            <?php
