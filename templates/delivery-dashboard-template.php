...
<head>
    ...
    <link rel="stylesheet" href="<?php echo esc_url(FXW_PLUGIN_URL . 'assets/css/frontend.css'); ?>" type="text/css"
        media="all" />
    <?php wp_head(); ?>
</head>
...
<body <?php body_class(); ?>>
    ...
    <div class="fxw-app-dashboard">
        ...
        <div class="fxw-tabs">
            <button class="fxw-tab-link active" onclick="openTab(event, 'new-orders')"><?php _e('New', 'foodxpress'); ?>
                (<?php echo count($new_orders); ?>)</button>
            <button class="fxw-tab-link"
                onclick="openTab(event, 'in-progress')"><?php _e('In Progress', 'foodxpress'); ?>
        ...
        <div class="fxw-order-card">
            ...
            <div class="fxw-card-body">
                <div class="fxw-card-section">
                    <p><span class="fxw-icon">&#128100;</span><strong><?php _e('Customer:', 'foodxpress'); ?></strong>
                        <?php echo esc_html($order->get_formatted_billing_full_name()); ?></p>
                    <p><span class="fxw-icon">&#128222;</span><strong><?php _e('Phone:', 'foodxpress'); ?></strong> <a
                            href="tel:<?php echo esc_attr($order->get_billing_phone()); ?>"><?php echo esc_html($order->get_billing_phone()); ?></a>
                    </p>

                    <?php if ($delivery_address): ?>
                        <p><span
                                class="fxw-icon">&#127968;</span><strong><?php _e('Delivery Address:', 'foodxpress'); ?></strong>
                            <?php echo esc_html($delivery_address); ?></p>
                        <?php if ($delivery_distance): ?>
                            <p><span class="fxw-icon">&#128207;</span><strong><?php _e('Distance:', 'foodxpress'); ?></strong>
                                <?php echo esc_html($delivery_distance); ?> km</p>
                        <?php endif; ?>
                    <?php else: ?>
                        <p><span class="fxw-icon">&#127968;</span><strong><?php _e('Address:', 'foodxpress'); ?></strong>
                            <?php echo wp_kses_post($shipping_address); ?></p>
                        <?php if ($unit): ?>
                            <p><span class="fxw-icon">&#128190;</span><strong><?php _e('Unit:', 'foodxpress'); ?></strong>
                                <?php echo esc_html($unit); ?></p>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
                <div class="fxw-card-section">
                    <p><span class="fxw-icon">&#128179;</span><strong><?php _e('Payment:', 'foodxpress'); ?></strong>
                        <?php echo esc_html($order->get_payment_method_title()); ?></p>
                    <?php if ('cod' === $order->get_payment_method()): ?>
                        <p class="fxw-collect-amount"><span
                                class="fxw-icon">&#128181;</span><strong><?php _e('Collect:', 'foodxpress'); ?></strong>
            ...
            <div class="fxw-card-footer">
                ...
                <?php if ('fxw-assigned' === $status): ?>
                    <button type="button" class="fxw-button fxw-button-pickup fxw-action-btn"
                        ...
                        <span class="fxw-icon">&#128230;</span><?php _e('Mark Picked Up', 'foodxpress'); ?>
                    </button>
                <?php endif; ?>
                <?php if ('fxw-picked-up' === $status): ?>
                    <button type="button" class="fxw-button fxw-button-deliver fxw-action-btn"
                        ...
                        data-order-id="<?php echo esc_attr($order->get_id()); ?>"
                        data-nonce="<?php echo esc_attr(wp_create_nonce('fxw_delivery_action')); ?>">
                        <span class="fxw-icon">&#127937;</span><?php _e('Mark Delivered', 'foodxpress'); ?>
                    </button>
                <?php endif; ?>
            </div>
        </div>
